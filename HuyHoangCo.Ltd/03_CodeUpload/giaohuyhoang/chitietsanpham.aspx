<%@ page language="C#" masterpagefile="~/front-end.master" autoeventwireup="true" inherits="chitietsanpham, App_Web_fmyesuqe" title="Giáo Huy Hoàng - Giáo xây dựng hải phòng, Cốp pha thép hải phòng, Dịch vụ vận tải hải phòng,Tranh đá quý hải phòng, Đá Quý Hải Phòng" theme="default" enableviewstate="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="noidung_chinh" runat="Server">
    <div class="bigbox">
        <div class="bigbox_dau">
            <span>
                <%# _loaiSanPham.TieuDe %></span></div>
        <div class="bigbox_than">
            <p class="tensanpham">
                <%# _sanPham.Ten %></p>
            <p class="gioithieusanpham">
                <%# _sanPham.GioiThieu %></p>
            <p class="anhsanpham">
                <img alt='' src='images/sanpham/<%# _sanPham.AnhDaiDien %>' /></p>
            <p>
    ...
    <div class="bigbox">
        <div class="bigbox_dau">
            <span>Sản phẩm cùng loại</span></div>
        <div class="bigbox_than">
