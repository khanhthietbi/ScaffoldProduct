<%@ page language="C#" masterpagefile="~/quantri/quantri.master" autoeventwireup="true" inherits="quantri_SanPhamKhuyenMai, App_Web_peu3pj14" title="Quản trị website - Sản phẩm khuyến mại" theme="quantri" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="NoiDungChinh" runat="Server">
    <div id="cot_phai">
        <fieldset>
            <legend>Sản phẩm khuyến mại</legend>
