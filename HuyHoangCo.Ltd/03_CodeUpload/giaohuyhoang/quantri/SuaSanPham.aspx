<%@ page language="C#" masterpagefile="~/quantri/quantri.master" autoeventwireup="true" validaterequest="false" inherits="quantri_SuaSanPham, App_Web_peu3pj14" title="Quản trị website - Sửa thông tin sản phẩm" theme="quantri" %>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddl_NLSP" runat="server" Width="250px" DataTextField="TieuDe"
                            ...
                            OnSelectedIndexChanged="ddl_NLSP_SelectedIndexChanged" 
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddl_LSP" runat="server" Width="250px" DataTextField="TieuDe"
                            DataValueField="ID" onprerender="ddl_LSP_PreRender">
                        </asp:DropDownList>
                        &nbsp;
